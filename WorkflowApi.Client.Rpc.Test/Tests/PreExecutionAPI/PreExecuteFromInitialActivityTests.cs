...
[TestClass]
public class PreExecuteFromInitialActivityTests
{
    ...
    public async Task ShouldGetPreExecutionActivitiesSequence_FromInitialActivity(TestService service)
    {
        ...
        var response = await service.Client.RpcPreExecution.WorkflowApiRpcPreExecuteFromInitialActivityAsync(new(processId));
    ...
    public async Task ShouldExecute_WhenPermissionAllowed(TestService service)
    {
        ...
        var response = await service.Client.ExclusivePermissions(c => c.RpcPreExecution, [OperationId.RpcPreExecuteFromInitialActivity]).WorkflowApiRpcPreExecuteFromInitialActivityAsync(new(processId));
