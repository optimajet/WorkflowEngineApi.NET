...
namespace WorkflowApi.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TenantReadinessResponse")]
    public partial class TenantReadinessResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TenantReadinessResponse" /> class.
        /// </summary>
        /// <param name="tenantStatus">tenantStatus.</param>
        public TenantReadinessResponse(TenantStatus tenantStatus = default(TenantStatus))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TenantReadinessResponse {\n");
