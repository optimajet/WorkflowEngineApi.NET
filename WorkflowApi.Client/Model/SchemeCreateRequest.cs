...
namespace WorkflowApi.Client.Model
{
    ...
    /// SchemeCreateRequest
    /// </summary>
    [DataContract(Name = "SchemeCreateRequest")]
    public partial class SchemeCreateRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SchemeCreateRequest" /> class.
        /// </summary>
        /// <param name="scheme">scheme.</param>
        /// <param name="canBeInlined">canBeInlined.</param>
        /// <param name="inlinedSchemes">inlinedSchemes.</param>
        /// <param name="tags">tags.</param>
        public SchemeCreateRequest(Scheme scheme = default(Scheme), bool canBeInlined = default(bool), List<string> inlinedSchemes = default(List<string>), List<string> tags = default(List<string>))
        {
            this.Scheme = scheme;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SchemeCreateRequest {\n");
