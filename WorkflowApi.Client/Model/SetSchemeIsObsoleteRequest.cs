...
namespace WorkflowApi.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SetSchemeIsObsoleteRequest")]
    public partial class SetSchemeIsObsoleteRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SetSchemeIsObsoleteRequest" /> class.
        /// </summary>
        /// <param name="schemeCode">schemeCode.</param>
        public SetSchemeIsObsoleteRequest(string schemeCode = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SetSchemeIsObsoleteRequest {\n");
