...
namespace WorkflowApi.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BulkGetProcessInstanceRequest")]
    public partial class BulkGetProcessInstanceRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkGetProcessInstanceRequest" /> class.
        /// </summary>
        /// <param name="processIds">processIds.</param>
        /// <param name="maxDegreeOfParallelism">maxDegreeOfParallelism.</param>
        public BulkGetProcessInstanceRequest(List<Guid> processIds = default(List<Guid>), int? maxDegreeOfParallelism = default(int?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BulkGetProcessInstanceRequest {\n");
