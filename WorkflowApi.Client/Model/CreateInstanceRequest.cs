...
namespace WorkflowApi.Client.Model
{
    ...
    public partial class CreateInstanceRequest : IValidatableObject
    {
        ...
        public CreateInstanceRequest(string schemeCode = default(string), Guid processId = default(Guid), string identityId = default(string), string impersonatedIdentityId = default(string), string calendarName = default(string), List<ProcessParameter> initialProcessParameters = default(List<ProcessParameter>))
        {
