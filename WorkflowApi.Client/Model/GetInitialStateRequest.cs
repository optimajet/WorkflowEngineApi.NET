...
namespace WorkflowApi.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetInitialStateRequest")]
    public partial class GetInitialStateRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetInitialStateRequest" /> class.
        /// </summary>
        /// <param name="schemeCode">schemeCode.</param>
        /// <param name="culture">culture.</param>
        public GetInitialStateRequest(string schemeCode = default(string), string culture = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetInitialStateRequest {\n");
