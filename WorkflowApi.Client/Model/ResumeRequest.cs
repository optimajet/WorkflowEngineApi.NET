...
namespace WorkflowApi.Client.Model
{
    ...
    /// ResumeRequest
    /// </summary>
    [DataContract(Name = "ResumeRequest")]
    public partial class ResumeRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResumeRequest" /> class.
        /// </summary>
        ...
        public ResumeRequest(Guid processId = default(Guid), string activityName = default(string), string identityId = default(string), string impersonatedIdentityId = default(string), List<ProcessParameter> processParameters = default(List<ProcessParameter>))
        {
