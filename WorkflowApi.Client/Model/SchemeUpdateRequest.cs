...
namespace WorkflowApi.Client.Model
{
    ...
    /// SchemeUpdateRequest
    /// </summary>
    [DataContract(Name = "SchemeUpdateRequest")]
    public partial class SchemeUpdateRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SchemeUpdateRequest" /> class.
        /// </summary>
        ...
        public SchemeUpdateRequest(string code = default(string), Scheme scheme = default(Scheme), bool? canBeInlined = default(bool?), List<string> inlinedSchemes = default(List<string>), List<string> tags = default(List<string>))
        {
            this.Code = code;
            this.Scheme = scheme;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SchemeUpdateRequest {\n");
