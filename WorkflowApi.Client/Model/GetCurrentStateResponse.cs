...
namespace WorkflowApi.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetCurrentStateResponse")]
    public partial class GetCurrentStateResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCurrentStateResponse" /> class.
        /// </summary>
        /// <param name="currentState">currentState.</param>
        public GetCurrentStateResponse(WorkflowState currentState = default(WorkflowState))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetCurrentStateResponse {\n");
