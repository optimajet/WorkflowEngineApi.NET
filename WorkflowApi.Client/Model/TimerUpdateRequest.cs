...
namespace WorkflowApi.Client.Model
{
    ...
    /// TimerUpdateRequest
    /// </summary>
    [DataContract(Name = "TimerUpdateRequest")]
    public partial class TimerUpdateRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TimerUpdateRequest" /> class.
        /// </summary>
        /// <param name="name">name.</param>
        /// <param name="nextExecutionDateTime">nextExecutionDateTime.</param>
        /// <param name="ignore">ignore.</param>
        public TimerUpdateRequest(string name = default(string), DateTimeOffset? nextExecutionDateTime = default(DateTimeOffset?), bool? ignore = default(bool?))
        {
            this.Name = name;
        ...
        /// </summary>
        [DataMember(Name = "nextExecutionDateTime", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TimerUpdateRequest {\n");
