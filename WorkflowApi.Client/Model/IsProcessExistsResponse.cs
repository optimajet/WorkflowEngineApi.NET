...
namespace WorkflowApi.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IsProcessExistsResponse")]
    public partial class IsProcessExistsResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IsProcessExistsResponse" /> class.
        /// </summary>
        /// <param name="isExists">isExists.</param>
        public IsProcessExistsResponse(bool isExists = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IsProcessExistsResponse {\n");
