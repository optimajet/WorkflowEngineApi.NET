...
namespace WorkflowApi.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BulkDeleteInstanceRequest")]
    public partial class BulkDeleteInstanceRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkDeleteInstanceRequest" /> class.
        /// </summary>
        /// <param name="processIds">processIds.</param>
        /// <param name="maxDegreeOfParallelism">maxDegreeOfParallelism.</param>
        public BulkDeleteInstanceRequest(List<Guid> processIds = default(List<Guid>), int? maxDegreeOfParallelism = default(int?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BulkDeleteInstanceRequest {\n");
