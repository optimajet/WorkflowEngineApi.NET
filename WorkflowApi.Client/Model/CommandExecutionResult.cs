...
namespace WorkflowApi.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CommandExecutionResult")]
    public partial class CommandExecutionResult : IValidatableObject
    {
        /// <summary>
        ...
        public CommandExecutionResult(string commandName = default(string), bool wasExecuted = default(bool), ProcessInstance processInstance = default(ProcessInstance), string message = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CommandExecutionResult {\n");
