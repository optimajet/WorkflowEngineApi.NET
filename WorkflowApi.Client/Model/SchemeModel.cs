...
namespace WorkflowApi.Client.Model
{
    ...
    /// SchemeModel
    /// </summary>
    [DataContract(Name = "SchemeModel")]
    public partial class SchemeModel : IValidatableObject
    {
        /// <summary>
        ...
        public SchemeModel(string code = default(string), Scheme scheme = default(Scheme), bool canBeInlined = default(bool), List<string> inlinedSchemes = default(List<string>), List<string> tags = default(List<string>))
        {
            this.Code = code;
            this.Scheme = scheme;
