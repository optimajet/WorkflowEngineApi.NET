...
namespace WorkflowApi.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetCurrentActivityNameResponse")]
    public partial class GetCurrentActivityNameResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCurrentActivityNameResponse" /> class.
        /// </summary>
        /// <param name="currentActivityName">currentActivityName.</param>
        public GetCurrentActivityNameResponse(string currentActivityName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetCurrentActivityNameResponse {\n");
