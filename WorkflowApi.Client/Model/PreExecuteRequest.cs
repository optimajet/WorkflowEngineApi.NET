...
namespace WorkflowApi.Client.Model
{
    ...
    /// PreExecuteRequest
    /// </summary>
    [DataContract(Name = "PreExecuteRequest")]
    public partial class PreExecuteRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PreExecuteRequest" /> class.
        /// </summary>
        /// <param name="processId">processId.</param>
        /// <param name="fromActivityName">fromActivityName.</param>
        public PreExecuteRequest(Guid processId = default(Guid), string fromActivityName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PreExecuteRequest {\n");
