...
namespace WorkflowApi.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetProcessStatusResponse")]
    public partial class GetProcessStatusResponse : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProcessStatusResponse" /> class.
        /// </summary>
        /// <param name="processStatus">processStatus.</param>
        public GetProcessStatusResponse(ProcessStatus? processStatus = default(ProcessStatus?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetProcessStatusResponse {\n");
